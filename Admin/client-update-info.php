...
<!-- Add this JavaScript code to your HTML -->
 <script>
        function loadContent(contentType) {
            ...
            xhttp.open("GET", contentType.toLowerCase() + ".php", true);
            xhttp.send();
        }
  </script>
  ...
  <i class="bi bi-person"></i><span>User information</span><i class="bi bi-chevron-down ms-auto"></i>
            ...
            <li class="nav-item">
              ...
              <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                ...
                <li>
                  <a class="active" href="client-update-info.php">
...
<!-- End Client Nav -->
  ...
  <span>Contact</span>
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-home')">Home</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-state')">State</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-city')">City</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-area')">Area</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-place')">Place</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-update-rent-price')">Rent Price</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-dec-type')">Decoration Type</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-update-dec-price')">Decoration Price</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-update-mngr-details')">Manager Details</a></li>
    ...
    <div id="content">
      ...
      <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
          ...
          <div class="jumbotron">
              ...
              <p class="lead">Welcome to our client information page. Here you can find detailed information about our clients.</p>
              <hr class="my-4">
              <p>We pride ourselves on serving a diverse range of clients with varying needs and preferences. Whether you're looking for individual services or seeking solutions for your business, we're here to assist you every step of the way.</p>
