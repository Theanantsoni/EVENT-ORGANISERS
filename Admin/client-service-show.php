...
<!-- End Client Nav -->
  ...
  <i class="bi bi-gear-wide-connected"></i><span>Services</span><i class="bi bi-chevron-down ms-auto"></i>
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="client-service-show.php" class="active">
...
<main id="main" class="main container">
    <h1 class="mt-5 mb-4 text-center">Client - Service - Show - Information Content</h1>
...
$sql = "SELECT id, image, title, description, description1, description2, description3, description4 FROM e_service LIMIT $offset, $recordsPerPage";
...
// Pagination
$totalPagesSql = "SELECT COUNT(*) AS total FROM e_service";
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterRows(input) {
      ...
      allRows.forEach(row => {
        const title = row.querySelector('td:nth-child(3)').textContent.toLowerCase().trim();
