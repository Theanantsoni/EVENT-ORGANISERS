...
<div class="container">
    <h1 class="display-4 text-center mt-5 mb-4">Rent Price Information</h1> <!-- Big heading -->
    <?php
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<thead class="thead-dark"><tr><th style="text-align: center;">Rent ID</th><th style="text-align: center;">Rent Price</th><th style="text-align: center;">Rent No</th></tr></thead>';
        echo '<tbody>';
