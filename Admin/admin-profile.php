...
<main id="main" class="main">
        ...
        <!-- <h2 class="text-center mt-3">Admin Profile</h2> -->
                ...
                <div class="col-md-6">
                    <div class="card mt-5">
                        <div class="card-header bg-primary text-white">
                            <h2 class="mb-0"><strong>Admin Profile</strong></h2>
                        </div>
                        <div class="card-body">
                            <form id="profileForm" class="form-container">
                                <div class="form-group">
                                    <label for="name">Name</label>
                                    <input type="text" class="form-control" id="name" name="name" value="Anant Soni" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" id="email" name="email" value="anantsoni07@gmail.com" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="contact">Contact</label>
                                    <input type="tel" class="form-control" id="contact" name="contact" value="8140591020" pattern="[0-9]{10}" readonly>
                                </div>
                            </form>
                        </div>
                    </div>
