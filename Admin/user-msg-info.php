...
<main id="main" class="main">
    ...
    <div class="row">
        <div class="col">
            <h2 class="text-center mt-4 mb-3">User Message Lists</h2>
            <?php
...
$sql = "SELECT u_id, u_name, u_email, u_contact, u_country, u_subject, u_message FROM e_message LIMIT $start, $records_per_page";
...
if ($result->num_rows > 0) {
    ...
    echo '<th style="text-align: center;">Subject</th>';
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td style='text-align: center;'>" . $row['u_contact'] . "</td>";
        echo "<td style='text-align: center;'>" . $row['u_country'] . "</td>";
        echo "<td style='text-align: center;'>" . $row['u_subject'] . "</td>";
        echo "<td style='text-align: center;'>" . $row['u_message'] . "</td>";
        echo "</tr>";
    }
    ...
    // Pagination links
    $sql = "SELECT COUNT(*) AS total FROM e_message";
    $result = $conn->query($sql);
    $row = $result->fetch_assoc();
    $total_pages = ceil($row['total'] / $records_per_page);

    echo '<div class="text-center" style="padding-left: 40%;">';
