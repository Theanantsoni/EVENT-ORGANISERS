...
<!-- End Client Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed show" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
    <i class="bi bi-images"></i><span>Gallery</span><i class="bi bi-chevron-down ms-auto"></i>
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="client-gallery-update.php" class="active">
...
$sql = "SELECT * FROM e_gallery LIMIT $start, $limit";
$result = mysqli_query($conn, $sql);

// Query to count total number of entries
$total_records = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM e_gallery"));
$total_pages = ceil($total_records / $limit);
?>

<main id="main" class="main">
    <h1 class="mt-5 mb-4 text-center">Client - Gallery - Show - Information Content</h1>

    <style>
        /* Added custom CSS for zoom effect */
        .zoomable-image {
    ...
    <table class="table table-bordered table-striped" id="galleryTable">
        <thead class="thead-dark">
            <tr>
                <th scope="col" style="text-align: center;">Image No.</th>
        ...
        <tbody>
            <?php while ($data = mysqli_fetch_array($result)) { ?>
                <tr>
                    <td style="text-align: center; padding-top: 13vh; font-size: 25px;"><?php echo $data['eg_id']; ?></td>
                    <td style="text-align: center;">
                        <img src="../images/Event Images/<?php echo $data['eg_img']; ?>" style="max-height: 200px;" alt="Image" class="zoomable-image">
                    </td>
                    <td style="text-align: center; padding-top: 13vh; font-size: 25px;"><?php echo $data['eg_name']; ?></td>
                    <td style="text-align: center; padding-top: 13vh;" class="border-2">
                        <a href="UD Files/client-gallery-data-update.php?eg_id=<?php echo $data['eg_id']; ?>" class="btn btn-primary" onclick="return confirm('Are You Sure To Update ? ')">Update</a>
                          &nbsp;&nbsp;
                        <a href="UD Files/client-gallery-data-delete.php?eg_id=<?php echo $data['eg_id']; ?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Delete ?')">Delete</a>
                    </td>
    ...
    <ul class="pagination justify-content-center">
        ...
        <button class="btn btn-success mr-2" data-toggle="modal" data-target="#addImageModal"><a href="UD Files/client-gallery-data-add.php" style="color: #fff;">Add Image and Details</a></button>

    </ul>

    <!-- Add Image and Details Code -->

    <!-- Add Image and Details button -->
