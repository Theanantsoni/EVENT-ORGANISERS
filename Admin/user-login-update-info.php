            ...
            <li class="nav-item">
              ...
              <ul id="users-info" class="nav-content collapse show" data-bs-parent=".sidebar-nav">
                <li>
                  ...
                  <ul id="user-info-option1" class="nav-content collapse show">
                    <li>
                    ...
                    <li>
                      <a href="user-login-update-info.php" class="active">
...
$sql = "SELECT COUNT(*) AS total FROM eu_login";
...
$sql = "SELECT u_id, u_email, u_password FROM eu_login LIMIT $offset, $recordsPerPage";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo '<div class="table-responsive">';
    echo '<table class="table table-bordered">';
    echo '<thead class="thead-dark"><tr><th style="text-align: center;">No.</th><th style="text-align: center;">Email</th><th style="text-align: center;">Password</th><th style="text-align: center;">Actions</th></tr></thead>';
    echo '<tbody>';
    // Initialize loop counter
    $loopNumber = 1 + ($currentPage - 1) * $recordsPerPage;
    // output data of each row
    while ($row = $result->fetch_assoc()) {
        echo "<tr><td style='text-align: center;'>" . $loopNumber . "</td><td style='text-align: center;'>" . $row["u_email"] . "</td><td style='text-align: center;'>" . $row["u_password"] . "</td>";
        echo "<td style='text-align: center;'>
                <a href='UD Files/user-login-data-update.php?id=" . $row["u_id"] . "' class='btn btn-primary' onclick=\"return confirm('Are you sure you want to update?');\">Update</a> 
                &nbsp;&nbsp;&nbsp; 
                <a href='UD Files/user-login-data-delete.php?id=" . $row["u_id"] . "' class='btn btn-danger' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a>
              </td></tr>";
