...
<!-- End Client Nav -->
  ...
  <ul id="booking-info-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
    ...
    <li>
      <a href="user-book-info-update.php" class="active">
...
if ($result->num_rows > 0) {
    ...
    echo '<thead class="thead-dark">
                <tr>
                    ...
                    <th style="text-align: center; padding-right: 70px; padding-left: 70px;" colspan="2">Actions</th>
                </tr>
            </thead>';
    echo '<tbody>';
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td style='text-align: center;'>
                    <a href='UD%20Files/user-book-data-update.php?id=".$row['u_id']."' class='btn btn-primary' onclick=\"return confirm('Are you sure you want to update?');\">Update</a>
                    &nbsp;
                    <a href='UD%20Files/user-book-data-delete.php?id=".$row['u_id']."' class='btn btn-danger' onclick=\"return confirm('Are you sure you want to delete?');\">Delete</a>
                </td>
            </tr>";
