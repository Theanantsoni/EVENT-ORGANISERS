...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['approve'])) {
        ...
        $sql = "UPDATE e_rate_or_feedback SET approval_status = 'approved' WHERE u_id = $feedback_id";
    ...
    if (isset($_POST['reject'])) {
        ...
        $sql = "UPDATE e_rate_or_feedback SET approval_status = 'rejected' WHERE u_id = $feedback_id";
        if (mysqli_query($conn, $sql)) {
