              ...
              <ul id="users-info" class="nav-content collapse show" data-bs-parent=".sidebar-nav">
                ...
                <li>
                  ...
                  <ul id="user-info-option2" class="nav-content collapse show">
                    <li>
                      <a href="user-register-show-info.php" class="active">
                        <i class="bi bi-circle"></i><span>Show informations</span>
                      </a>
                    </li>
                    <li>
...
<h1 class="display-6 custom-heading"> User Register Show Information </h1>
...
$sql = "SELECT u_id,u_fname,u_lname, u_address, u_email, u_contact, u_password, u_rptpwd FROM eu_registration LIMIT $start, $limit";
...
if ($result->num_rows > 0) {
    ...
    echo '<thead class="thead-dark">
            <tr>
              ...
              <th style="text-align: center;">Repeat Password</th>
            </tr>
          </thead>';

    echo '<tbody>';
    $count = $start + 1; // Counter for displaying serial number
