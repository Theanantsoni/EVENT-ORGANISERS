...
<!-- End Client Nav -->
    ...
    <i class="bi bi-images"></i><span>Gallery</span><i class="bi bi-chevron-down ms-auto"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed show" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
  <i class="bi bi-gear-wide-connected"></i><span>Services</span><i class="bi bi-chevron-down ms-auto"></i>
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="client-service-update.php" class="active">
...
<main id="main" class="main container">
    <h1 class="mt-5 mb-4 text-center">Client - Service - Update - Information Content</h1>
...
$sql = "SELECT id, image, title, description, description1, description2, description3, description4 FROM e_service LIMIT $start, $limit";
...
if ($result->num_rows > 0) {
    ...
    <table class="table table-bordered table-striped">
        <thead class="thead-dark">
            <tr>
                <th class="border-2" style="text-align: center;">ID</th>
                <th class="border-2" style="text-align: center;">Image</th>
                <th class="border-2" style="text-align: center;">Title</th>
                <th class="border-2" style="text-align: center;">Description</th>
                <th class="border-2" style="text-align: center;">Action</th> <!-- New column for Update button -->
            </tr>
        </thead>
        <tbody>
            <?php
            while ($row = $result->fetch_assoc()) {
                ?>
                <tr>
                    <td class="border-2" width="10%" style="text-align: center;"><?php echo $row['id']; ?></td>
                    <td class="border-2" style="text-align: center;"><img src="../images/<?php echo $row['image']; ?>" alt="Service Image" style="max-width: 250px;max-width: 250px;"></td>
                    <td class="border-2" width="30%" style="text-align: center;"><?php echo $row['title']; ?></td>
                    <td class="border-2" width="70%" style="text-align: center;">
                        <ul class="list-unstyled">
                            <li><?php echo $row['description']; ?></li><br>
                            <li><?php echo $row['description1']; ?></li><br>
                            <li><?php echo $row['description2']; ?></li><br>
                            <li><?php echo $row['description3']; ?></li><br>
                            <li><?php echo $row['description4']; ?></li>
                        </ul>
                    </td>
                    <td class="border-2">
                        <a href="UD Files/client-service-data-update.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Update</a> <!-- Update button -->
                    </td>
                </tr>
                <?php
            }
...
// Pagination links
$sql = "SELECT COUNT(id) AS total FROM e_service";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
$total_pages = ceil($row["total"] / $limit);


echo '<ul class="pagination" style="padding-left: 40%;">';
if ($page > 1) {
