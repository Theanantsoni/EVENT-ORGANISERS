              ...
              <ul id="users-info" class="nav-content collapse show" data-bs-parent=".sidebar-nav">
                <li>
                  ...
                  <ul id="user-info-option1" class="nav-content collapse show">
                    <li>
                      <a href="user-login-show-info.php" class="active">
...
<h1 class="display-6 custom-heading"> User Login Show Information </h1>
...
$sql = "SELECT u_id, u_email, u_password FROM eu_login LIMIT $offset, $records_per_page";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo '<div class="table-responsive">';
    echo '<table class="table table-bordered">';
    echo '<thead class="thead-dark"><tr><th style="text-align: center;">No.</th><th style="text-align: center;">Email</th><th style="text-align: center;">Password</th></tr></thead>';
    echo '<tbody>';
    // Initialize loop counter
    $loopNumber = 1 + ($page - 1) * $records_per_page;
