...
<div class="container">
    <h1 class="display-4 text-center mt-5 mb-4">Decoration Price Information</h1> <!-- Modified heading -->
    <?php
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo '<thead class="thead-dark"><tr><th style="text-align: center;">Decprice ID</th><th style="text-align: center;">Decoration Price</th><th style="text-align: center;">Decprice No</th></tr></thead>';
        echo '<tbody>';
