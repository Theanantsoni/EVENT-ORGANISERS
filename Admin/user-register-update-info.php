    ...
    <ul class="sidebar-nav" id="sidebar-nav">
     ...
     <ul class="nav flex-column">
            <li class="nav-item">
              ...
              <ul id="users-info" class="nav-content collapse show" data-bs-parent=".sidebar-nav">
                <li>
                ...
                <li>
                  ...
                  <ul id="user-info-option2" class="nav-content collapse show">
                    <li>
                    ...
                    <li>
                      <a href="user-register-update-info.php" class="active">
                        <i class="bi bi-circle"></i><span>Update informations</span>
                      </a>
                    </li>
                  </ul>
...
<h1 class="display-6 custom-heading"> User Register Update Information </h1>
...
$sql = "SELECT u_id, u_fname,u_lname, u_address, u_email, u_contact, u_password, u_rptpwd FROM eu_registration LIMIT $start_from, $records_per_page";
...
if ($result->num_rows > 0) {
    ...
    echo '<thead class="thead-dark">
            <tr>
              ...
              <th style="text-align: center; padding-left: 50px; padding-right: 50px;">Address</th>
              <th style="text-align: center;">Email Id</th>
              <th style="text-align: center;">Contact_No.</th>
              <th style="text-align: center;">Password</th>
              <th style="text-align: center;">Repeat_Password</th>
    ...
    $loopNumber = ($page - 1) * $records_per_page + 1;
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr>
                <td style='text-align: center;'>".$loopNumber."</td>
                <td style='text-align: center;'>".$row["u_fname"]."</td>
                <td style='text-align: center;'>".$row["u_lname"]."</td>
                <td style='text-align: center;'>".$row["u_address"]."</td>
                <td style='text-align: center;'>".$row["u_email"]."</td>
                <td style='text-align: center;'>".$row["u_contact"]."</td>
                <td style='text-align: center;'>".$row["u_password"]."</td>
                <td style='text-align: center;'>".$row["u_rptpwd"]."</td>
                <td style='text-align: center; white-space: nowrap;'>
                    <a href='UD Files/user-register-data-update.php?id=" . $row["u_id"] . "' class='btn btn-primary btn-sm' onclick=\"return confirm('Are you sure you want to update?');\">Update</a> &nbsp;
                    <a href='UD Files/user-register-data-delete.php?id=" . $row["u_id"] . "' class='btn btn-danger btn-sm' onclick=\"return confirm('Are you sure you want to Delete?');\">Delete</a>
                </td>
            </tr>";
    ...
    // Pagination links
    $sql = "SELECT COUNT(*) AS total FROM eu_registration";
    $result = $conn->query($sql);
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function filterRows(input) {
      ...
      allRows.forEach(row => {
        const email = row.querySelector('td:nth-child(5)').textContent.toLowerCase().trim();
        const contact = row.querySelector('td:nth-child(6)').textContent.toLowerCase().trim();

        if (email.includes(filterValue) || contact.includes(filterValue)) {
