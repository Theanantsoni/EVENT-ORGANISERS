  ...
  <i class="bi bi-person"></i><span>User information</span><i class="bi bi-chevron-down ms-auto"></i>
            ...
            <li class="nav-item">
              ...
              <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                <li>
                  <a class="active"  href="client-show-info.php">
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-rent-price')">Rent Price</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-dec-type')">Decoration Type</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-dec-price')">Decoration Price</a></li>
                <li class="breadcrumb-item"><a href="#" onclick="loadContent('client-show-mngr-details')">Manager Details</a></li>
