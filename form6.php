<?php
   ...
   // Insert data and generate bill process in running mode

   /////// ANANT CODE - NOT DISPLAY PAYMENT POP_UP
?>
...
function initiateRazorpayPayment() {
    ...
    var $billing_discount = $('#tprice').val();
    ...
    var options = {
        ...
        "handler": function(response) {
            ...
            window.location.href = "submitpayment_demo.php?payment_id=" + response.razorpay_payment_id;
        },
        "modal": {
            "ondismiss": function() {
...
jQuery(document).ready(function($) {
    $('#payNow').click(validateFormAndInitiatePayment);
});
...
<form id="payForm" action="form6.php" method="POST" onsubmit="validateFormAndInitiatePayment(event)">
      <div class="form-row">
