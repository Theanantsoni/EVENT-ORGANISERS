<?php
   ...
   //Alert ...In this code ... without javascript and insert data & generated bill ... Payment Process will be display. ...............
?>
...
<div class="form-row">
  ...
  <div class="form-group col-xl-4">
    ...
    <input type="text" name="tprice" style="background: transparent; color: #fff;" class="form-control glow-effect" id="tprice" readonly>
      ...
      &nbsp;&nbsp;&nbsp;
  <button type="button" id="payNow" class="btn btn-register" style="color: white;">Pay Now</button>
...
jQuery(document).ready(function($) {
    $('#payNow').click(function(e) {
        ...
        var payAmount = parseFloat($('#tprice').val()/2) || 0; // Default to 0 if NaN
