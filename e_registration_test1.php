...
<head>
  ...
  <style>
    body {
      background-image: url('https://img.freepik.com/free-vector/geometric-gradient-futuristic-background_23-2149116406.jpg?size=626&ext=jpg&ga=GA1.1.1700460183.1708300800&semt=ais'); /* Replace 'background.jpg' with your image file */
      ...
      <div class="col-md-6">
        <div class="form-container">
          <h2 class="text-center mb-4">Registration Form</h2>
              ...
              <form action="e_registration_test1.php" method="POST" onsubmit="return form()">
                <div class="row">
                    <div class="col-md-6">
...
<?php
    ...
    if(isset($_POST['btnsubmit'])) 
    {
        ...
        $select = "select u_email from eu_login WHERE u_email='$email'";
        ...
        if($count > 0)
        {
                echo '<script>alert("Your Email-Id is already registered ... Please Log in...");</script>';
